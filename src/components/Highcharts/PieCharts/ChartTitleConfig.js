...
import {PieChartTitleConfig} from '../../../actions/PieChartActions';
...
class ChartTitleConfig extends Component {
  constructor(props){
    super(props)
    this.state = {
...
updateTitleConfigData(text, align,margin, useHTML, verticalAlign, color, fontSize, fontWeight, fontFamily){
    ...
    this.props.dispatch(PieChartTitleConfig(chartTitleConfig))
}
...
export default connect(mapStateToProps)(ChartTitleConfig);
